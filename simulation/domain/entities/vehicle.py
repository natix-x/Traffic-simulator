...
from simulation.domain.models import VehicleDirection, VehicleType, Position, VehicleState
from simulation.ui.resources.images.vehicle_images import VEHICLE_IMAGES
...
class Vehicle:
    ...
    def move(self):
        ...
        if self.current_state == VehicleState.APPROACH and self.is_at_the_stop_line():
            ...
            self.current_intersection.vehicles_passed += 1
